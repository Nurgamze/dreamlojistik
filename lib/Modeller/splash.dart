                    ...
                    children: <Widget>[
                      ...
                      Container(
                        child: Row(
                          ...
                          children: [
                            Text("Dream bir ",style: TextStyle(color: Colors.white,fontWeight: FontWeight.w600),),
                            Image.asset("assets/images/splashlogosds.png",height: 20,),
                            Text(" markasıdır",style: TextStyle(color: Colors.white,fontWeight: FontWeight.w600),),
                          ],
                        ),
                      ),
                      Padding(
